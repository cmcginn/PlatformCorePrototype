myApp.controller('AbnTestController', ['$scope', '$timeout', '$resource', function ($scope, $timeout, $resource) {
    ...
    $scope.try_async_load = function () {
        ...
        var remoteTree = $resource('Scripts/app/platform/resources/treedata.json');
